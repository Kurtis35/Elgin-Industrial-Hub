    ...
    <footer className="bg-zinc-950 border-t border-zinc-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-5">
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-white font-bold text-lg">Elgin Tool</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service} className="flex items-center gap-1.5 text-gray-400 text-sm">
                  <span className="w-1 h-1 bg-orange-500 rounded-full" />
                  {service}
                </li>
              ))}
          ...
          <div>
            <h4 className="text-white font-bold text-base mb-5 tracking-wide">Service Areas</h4>
            <ul className="space-y-3 mb-7">
              {["Grabouw", "Botriver", "Villiersdorp", "Elgin Valley", "Surrounding Areas"].map((area) => (
                <li key={area} className="flex items-center gap-1.5 text-gray-400 text-sm">
            ...
            <div className="bg-orange-500/10 border border-orange-500/25 rounded-xl p-4">
              <p className="text-orange-400 font-semibold text-sm mb-1">Afrox Approved Supplier</p>
              <p className="text-gray-500 text-xs">Certified safe gas supplier you can trust</p>
            </div>
          </div>
        </div>

        <div className="border-t border-zinc-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
