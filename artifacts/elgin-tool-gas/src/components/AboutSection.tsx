        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-5">
              With over <span className="text-orange-400 font-semibold">25 years of experience</span> in the gas and industrial tools industry, Jeremy has built a reputation as the go-to expert in the Elgin Valley.
            </p>
            <p className="text-gray-400 text-lg leading-relaxed mb-5">
              His career spans industry giants like <span className="text-white font-semibold">Hitti</span> and <span className="text-white font-semibold">Apple Somerset West</span>, giving him unrivalled knowledge of tools, gas, safety equipment, and what local businesses truly need.
            </p>
            <p className="text-gray-400 text-lg leading-relaxed mb-10">
              Today, <span className="text-white font-semibold">Elgin Tool & Gas</span> brings that expertise directly to your door — serving farms, workshops, homes, and businesses across Grabouw, Botriver, and Villiersdorp with speed, reliability, and a personal touch.
            </p>
          ...
          >
            <div className="relative bg-zinc-900 border border-zinc-800 rounded-3xl p-10 overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-2xl font-black text-white mb-1">Jeremy</h3>
                <p className="text-orange-400 font-semibold mb-6">Owner & Industrial Expert</p>
                ...
                <blockquote className="text-gray-400 text-sm italic leading-relaxed border-l-2 border-orange-500 pl-4 text-left">
                ...
                <p className="text-orange-400 font-semibold text-sm mt-3 text-left">— Jeremy, Founder</p>
              </div>
            </div>
          </motion.div>
        </div>
